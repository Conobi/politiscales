        ...
        var axesDrawInfo = [
          {
            ...
            color0: "#a425b6",
            color1: "#34b634",
            name0: $.i18n("constructivism"),
            name1: $.i18n("essentialism")
          },
          {
            key: "j",
            color0: "#14bee1",
            color1: "#e6cc27",
            name0: $.i18n("rehabilitative_justice"),
            name1: $.i18n("punitive_justice")
          },
          {
            key: "s",
            color0: "#850083",
            color1: "#970000",
            name0: $.i18n("progressive"),
            name1: $.i18n("conservative")
          },
          {
            key: "b",
            color0: "#3e6ffd",
            color1: "#ff8500",
            name0: $.i18n("internationalism"),
            name1: $.i18n("nationalism")
          },
          {
            key: "p",
            color0: "#cc0000",
            color1: "#ffb800",
            name0: $.i18n("communism"),
            name1: $.i18n("capitalism")
          },
          {
            key: "m",
            color0: "#269B32",
            color1: "#6608C0",
            name0: $.i18n("regulation"),
            name1: $.i18n("laissez_faire")
          },
          {
            key: "e",
            color0: "#a0e90d",
            color1: "#4deae9",
            name0: $.i18n("ecology"),
            name1: $.i18n("production")
          },
          {
            key: "t",
            color0: "#eb1a66",
            color1: "#0ee4c8",
            name0: $.i18n("revolution"),
            name1: $.i18n("reform")
          }
        ];
...
function download_image() {
  ...
  link.download = "PolitiScales_"+$.i18n("results")+"_"+new Date().toLocaleDateString()+".png";
